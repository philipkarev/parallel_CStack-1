  # Данный проект - это моё решение представленной ниже задачи _без использования STL_.
  ...
  **_Сложение объектов (нахождение глобальной суммы) и циклический сдвиг необходимо распараллелить с помощью библиотеки OpenMP._**
